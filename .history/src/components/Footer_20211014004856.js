...
function Footer() {
  return (
    ...
    {/* Grid container */}
    {/* Copyright */}
    <div className="text-center text-white p-3" style={{backgroundColor: '#57606f',color:'white'}}>
      © 2021 Copyright:
      <a className="text-white" href="https://www.facebook.com/longdevelop"> FASHION SHOP</a>
    </div>
    {/* Copyright */}
  </footer>
  )
