...
Chúng tôi tự hào là đơn vị mang đến cho KHÁCH HÀNG phong cách thời trang trẻ trung, gu ăn mặc đơn giản, giúp KHÁCH HÀNG có thể TỰ TIN nhất trong mọi lúc, mọi nơi.
              ...
              <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                ...
                <p>
                  <a href="#!" className="text-reset">Shoppe </a>
                </p>
                <p>
                  <a href="#!" className="text-reset">Lazada</a>
                </p>
                <p>
                  <a href="#!" className="text-reset">Tiki</a>
                </p>
              </div>
              {/* Grid column */}
              {/* Grid column */}
              <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                ...
                <p><i className="fas fa-phone me-3" /> + 123.456.789</p>
