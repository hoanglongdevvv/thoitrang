...
export class Header extends Component {
    ...
    render() {
        ...
        return (
            <div>
                {/* Navbar */}
                <nav className="navbar navbar-expand-lg navbar-light bg-ư">
                    {/* Container wrapper */}
                    <div className="container-fluid">
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <a className="navbar-brand mt-2 mt-lg-0" href="/">
                                <img src="https://blogger.googleusercontent.com/img/a/AVvXsEhl98yirgR0gauMY481dRz0d4TmvPL3cDgsjQrrMM1E8d-6GELoRAuSLJmkfjVKID3DSSB45rVcDoUG8DPdHU2D4FYQkG3dvNybgFvlGdgP3NiZBhQ0MA83YGsjuVg_ILGsU_VHdcZ0L5WRLEq_XnrqNlMuryczyOfF5gOpL2Wzg8Br_1xQCVcin8uqTg" height={50} alt="" loading="lazy" />
                            </a>
                            {/* Left links */}
