...
export class Payment extends Component {
    render() {
        return (
                ...
                <div className="form-outline  mb-4">
                <label className="form-label" htmlFor="form4Example1">Nhập Gmail - SĐT</label>
                ...
                <div className="form-outline form-blac mb-4">
                    <textarea className="dulieu form-control" id="form4Example3" rows={4} defaultValue={""} placeholder="Phản Ánh Sản Phẩm Ở Đây !" />
