...
export class Payment extends Component {
    thaydoisukien(event) {
        const data = $('form#test-form').serialize();
                  $.ajax({
                            type : 'GET', 
                            url : 'URL API của bạn',
                            dataType:'json',
    ...
    render() {
        return (
            ...
            action="https://docs.google.com/forms/u/0/d/e/1FAIpQLSep5Eg7f7SV4WFvd-T5PQlG-MJBP82HETRsbd3eQIC3WQx2dQ/formResponse"  target="_blank"
