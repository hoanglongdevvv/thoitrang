    ...
    <>
        ...
        <div className="row g-0">
          <div className="col-md-4">
            <img src="https://cdn.mykiot.vn/2021/04/1617965176db9d5bc0a237f9f6415d8ed19856aced.jpg" height="200px" alt="..." className="img-fluid" />
          </div>
      ...
      <div className="card mb-3" style={{maxWidth: '100%'}}>
        <div className="row g-0">
          <div className="col-md-4">
            <img src="https://i.pinimg.com/736x/d9/39/7a/d9397acbab31c290b834e95194121154.jpg" alt="..." className="img-fluid" />
          </div>
          <div className="col-md-8">
            <div className="card-body">
