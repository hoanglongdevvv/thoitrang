...
export class Payment extends Component {
    render() {
        return (
            <form style={{ display: 'block', marginLeft: 'auto', marginRight: 'auto', width: '500px', background: '#f5f6fa', fontSize: '25px', fontWeight: 'bold', borderRadius:'10px',    border: '1px solid #ddd', box-shadow: 0 0 20px #ced6e0; }}>
                {/* Email input */}
