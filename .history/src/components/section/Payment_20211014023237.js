...
export class Payment extends Component {
    render() {
        return (
            <form style={{ display: 'block', marginLeft: 'auto', marginRight: 'auto', width: '500px', background: '#f5f6fa', fontSize: '25px', fontWeight: 'bold' }}>
                {/* Email input */}
                ...
                {/* Submit button */}
                <button type="submit" className="btn btn-primary btn-block mb-4" style={{height:'20'}}>Send</button>
            </form>
        )
    }
}
