...
export class Payment extends Component {
    render() {
        return (
            <form style={{ display: 'block', marginLeft: 'auto', marginRight: 'auto', width: '500px', background: '#f5f6fa', fontSize: '25px', fontWeight: 'bold', borderRadius:'10px', border:'0.5px solid' }}>
                {/* Email input */}
