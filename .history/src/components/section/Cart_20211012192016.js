                ...
                <>
                    {
                        cart.map(item => (
                            <div className="details cart" key={item._id}>
                                ...
                                <div className="delete" onClick={() => removeProduct(item._id)} style={{ backgroundColor: '#78e08f', fontSize: '15px', }}>
                                <img src="https://e7.pngegg.com/pngimages/870/983/png-clipart-rubbish-bins-waste-paper-baskets-computer-icons-recycling-bin-wastewater-others-miscellaneous-blue.png" alt="..." />
                                </div>
                            </div>
                        ))
                    }
