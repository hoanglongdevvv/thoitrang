                ...
                <nav className="hoanglong navbar navbar-expand-lg navbar-white bg-white">
                    ...
                    <div className="container-fluid" style={{background:'white'}}>
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            {/* Navbar brand */}
                            <a className="hinhanh navbar-brand mt-2 mt-lg-0" href="/">
                            ...
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0" style={{fontSize:'17px'}}>
                                <li className="nav-item">
                                    <Link style={{color:'#636e72'}} className="nav-link" to="/">Home</Link>
                                </li>
                                <li className="nav-item">
                                    <Link style={{color:'#636e72'}} className="nav-link" to="/product">Product</Link>
                                </li>
                                <li className="nav-item">
                                    <Link style={{color:'#636e72'}} className="nav-link" to="/Seach">Voucher</Link>
                                </li>
                                <li className="nav-item">
                                    <Link style={{color:'#636e72'}} className="nav-link" to="/about">About</Link>
                                </li>
                        ...
                        <div className="d-flex align-items-center">
                            ...
                            <div className="text-reset me-3">
                                <span className="biendem">{cart.length}</span>
                                <Link to="/cart">
                            ...
                            <a className="dropdown-toggle d-flex align-items-center hidden-arrow" href="/" id="navbarDropdownMenuLink" role="button" data-mdb-toggle="dropdown" aria-expanded="false">
                                <img src="../components/img/logo.jpg" className="rounded-circle" height={25} alt="" loading="lazy" />
                            </a>
