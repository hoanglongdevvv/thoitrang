...
export class DataProvider extends Component {
    ...
    state = {
        products: [
          ...
          {
              "_id": "5",
              "title": "Áo thun Len Titishop ATN249",
              "src": "https://product.hstatic.net/1000147171/product/7_e2126f88d5964b9fb8ce85adc6711380_large.png",
              "description": "Hàng Mới Nhập Từ Quãng Châu",
              "Content": "Giảm Giá 30% Trong Hôm Nay",
              "price": 10,
              "colors":["orange","black","crimson","teal"],
